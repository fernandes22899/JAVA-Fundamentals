...
public class DNASequence
{
    ...
    {  
        ...
        {
          throw new DNASequenceException( " header or dna is null");
        }
        else 
        {
        ...
        {
          throw new DNASequenceException( " header does not start with > or the lenght is less than 2");
        }
         Scanner scanFile = new Scanner( header );
         String scan = scanFile.next();
         if ( scan.length() < 2 )
         {
           throw new DNASequenceException( "does not contain ID" );
         }
         ...
         if ( dna.length() < 1 )
         {
           throw new DNASequenceException( " dna length is less than 1 ");
         }
